...
public class AutofillPopup extends Window {
  ...
  public AutofillPopup(final String efoTerm,
                       final EFOServiceAsync efoServiceAsync,
                       final GuiMediator guiMediator) {
    super();
    ...
    characteristicInput.setValueMap(GlobalConfigs.getCommonFactorsOrChars());
    ...
    form.setFields(addToAllRecordsCheckBox, newCharacteristicCheckbox, characteristicInput,
      termSourceRefCheckbox, termSourceRef, termSourceNumberCheckbox, termSourceNum);
  ...
  private void submit(String efoTerm) {
    ...
    if (addToAllRecordsCheckBox.getValueAsBoolean() == true) {
      if (termSourceNumberChecked) {
        guiMediator.addColumnToCharacteristicAndAddValueToAllRecords("Term Accession Number", termSourceNum
            .getDisplayValue());
      }
      ...
      if (newCharacteristicChecked) {
        guiMediator.addColumnToCharacteristicAndAddValueToAllRecords("Characteristics["
                                                                     + characteristicString + "]", efoTerm);
      }
    }
