...
public class SDRF_Section extends SectionStackSection {
	...
	/*
	 * Used to modify all of the records even after filtering If you plan to
	 * add/remove anything to the grid, you must edit this list
	 */
	...
	public SDRF_Section(final GuiMediator guiMediator) {
		...
		automaticFunctionEditor.setTabs(filterAndReplaceTab,
				createNewColumnsTab);
		automaticFunctionEditor.setTabBarControls(TabBarControls.TAB_SCROLLER,
				TabBarControls.TAB_PICKER, editColumnsButton);
